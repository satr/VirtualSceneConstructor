...
namespace VirtualScene.EntityPresentationComponents.WPF.Commands.GeometryCommands
{
    ...
    public class AddCylinderCommand : AddSceneObjectCommandBase
    {
        ...
        private int _y;
        /// <summary>
        /// Creates a new instance of the <see cref="AddCylinderCommand"/>
        /// </summary>
        ...
        protected override void Execute()
        {
            _x += 1;
            _y += 1;
            ServiceLocator.Get<BusinessManager>().AddSceneElementInSpace(SceneContent, CylinderFactory.Create(), _x, _y, 0, Resources.Title_Cylinder);
        }
    }
}
